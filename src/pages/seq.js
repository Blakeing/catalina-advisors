...
const Seq = () => {
  ...
  const yPosAnim = useTransform(scrollYProgress, [0, 0.3, 1], [0, 200, 500])

  const opacityAnim = useTransform(scrollYProgress, [0, 0.5], [1, 0])

  // const variants = {
  //   hidden: { opacity: motionNav, y: 200 },
  //   visible: { opacity: motionNav, y: 0 },
  // }
    ...
    <>
      ...
      >
        <div className="hs-container">
          ...
          >
            <motion.div
              //animate={scrollY.current < 300 ? "visible" : "hidden"}
              //variants={variants}
              style={{ top: 0, opacity: opacityAnim, y: yPosAnim }}
